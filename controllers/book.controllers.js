...
//       // req.flash('success', 'Apartment created successfully');
//       // res.redirect('/'); // Redirect to homepage on success
//   } catch (error) {
//       console.error('Error creating apartment:', error);
//       req.flash('error', 'Failed to create apartment. Please try again.');
//       res.redirect('/apartment/new-apartment'); // Redirect to form with error message
//   }
// };