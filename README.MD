...
Recuerda tener en cuenta los principios REST API. Para este ejercicio, lo más importante es establecer una respuesta JSON consistente y que ofrezca información del resultado de la operación
